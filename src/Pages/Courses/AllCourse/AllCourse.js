        ...
        <div className=''>
            <div className='grid grid-cols-1 md:grid-cols-12'>
                <div className=' md:col-span-4 w-full flex justify-center'>
                    <div className=''>
                        <div className='flex items-center p-4 mt-4  bg-gradient-to-l from-transparent via-red-50 to-transparent'>
                            ...
                            courses.map((course, index) => {
                                return (
                                    <NavLink key={course.id} to={`/course/${course.id}`}>
                                        <div className='hover:shadow flex items-center space-x-2 text-green-500 rounded drop-shadow mb-2 p-4' >
